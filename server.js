...
7. AYNAN ${numSlides} ta slayd tayyorla`;
    ...
    for (const [idx, slide] of slidesData.slides.entries()) {
      ...
      // Left accent bar
      s.addShape('rect', { x: 0, y: 0, w: 0.12, h: '100%', fill: { color: c.accent }, line: { color: c.accent } });
      ...
      if (idx === 0) {
        ...
        s.addShape('rect', { x: 2, y: 3.7, w: 6, h: 0.04, fill: { color: c.accent }, line: { color: c.accent } });
